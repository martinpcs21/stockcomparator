...
from UserClasses import CheckableComboBox
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, fundamental_analysis_df):
        ...
        self.tabWidget.addTab(self.tab, "Easy")
        self.tabWidget.addTab(self.tab2, "Expert")
        self.table = QtWidgets.QTableView(self.tab2)
        ...
        self.label1=QtWidgets.QLabel("Sector",self)
        self.comboBox1 = QtWidgets.QComboBox()
        self.label2 = QtWidgets.QLabel("Company", self)
        self.list2 = QtWidgets.QListWidget()
        self.list2.setMaximumSize(200,10000)
        for company in data.index.tolist():
            QListWidgetItem(company, self.list2)
        self.list2.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
        self.comboBox2= QtWidgets.QComboBox()
        self.comboBox2.addItems(data.index.tolist())
        self.verticalLayoutRight.addWidget(self.table)
        self.verticalLayoutLeft.addWidget(self.label1)
        self.verticalLayoutLeft.addWidget(self.comboBox1)
        self.verticalLayoutLeft.addWidget(self.label2)
        self.verticalLayoutLeft.addWidget(self.list2)
